...
-(void)drawViewRect
{
//    self.navigationItem.leftBarButtonItem =[[UIBarButtonItem alloc]initWithTitle:@"back" style:(UIBarButtonItemStylePlain) target:self action:@selector(backToIndex)];
    ...
    EScrollerView *scroller=[[EScrollerView alloc] initWithFrameRect:CGRectMake(0, 0, 320, 160)
                                                          scrolArray:self.data needTitile:YES];
    //-(id)initWithFrameRect:(CGRect)rect scrolArray:(NSDictionary *)array needTitile:(BOOL)isNeedTitle//NSArray
...
//        [imageView setImage:image];
        ...
        if (i == 0 ) {
            label1.text = @"葫芦瓜";
            [btn setImage:[UIImage imageNamed:@"http://120.24.50.82:8180/upload/1/1737ca12-6fe3-4514-8014-ef06c786f690.png"] forState:0];
        }
        else if(i == 1)
        {
            label1.text = @"香蕉";
        ...
        {
            label1.text = @"奇异果";
            [btn setImage:[UIImage imageNamed:@"df_04_.png"] forState:0];
        }
    ...
    for (int i =0; i<4; i++)
    {
        ...
        if (i == 0 ) {
            fourLab.text = @"蔬菜";
            [fourBtn setBackgroundImage: [UIImage imageNamed:@"default_01.png"] forState:0];
        }
        else if(i == 1)
        {
            fourLab.text = @"干货";
            [fourBtn setBackgroundImage: [UIImage imageNamed:@"default_04.png"] forState:0];
        }
        else if( i == 2)
        {
            fourLab.text = @"水果";
        ...
        {
            fourLab.text = @"杂粮";
            [fourBtn setBackgroundImage: [UIImage imageNamed:@"default_03.png"] forState:0];
        }
        //-------0831---
...
-(void)initWithData:(NSDictionary *)data
{
    ...
    for (id value in data)
    {
        ...
        NSDictionary *dicList = value;
        for (id key in dicList) {
            NSLog(@"key:%@",key);
            NSLog(@"value:%@",[dicList objectForKey:key]);
        }
    }
}
//
