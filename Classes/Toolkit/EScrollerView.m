...
-(id)initWithFrameRect:(CGRect)rect scrolArray:(NSDictionary *)array needTitile:(BOOL)isNeedTitle
{
    if ((self = [super initWithFrame:rect])) {
        ...
        for (id value in array)
        {
            ...
            NSURL *url = [NSURL URLWithString:[value objectForKey:@"imagePath"]];
        ...
        pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(320-pageControlWidth-40, scrollView.frame.size.height-15, pageControlWidth, 10)];
...
-(id)initWithFrameRect2:(CGRect)rect scrolArray:(NSDictionary *)array needTitile:(BOOL)isNeedTitle//NSArray
{
...
//    }
    NSDictionary *dataList = [[NSDictionary alloc] init];
    dataList = array;
	if ((self=[super initWithFrame:rect]))
    {
        self.userInteractionEnabled=YES;
...
//            }
            ...
            NSURL *url = [NSURL URLWithString:@"http://120.24.50.82:8180/upload/1/1737ca12-6fe3-4514-8014-ef06c786f690.png"];
            NSData *data = [NSData dataWithContentsOfURL:url];
            UIImage *image = [[UIImage alloc] initWithData:data];
            [imgView setImage:image];
